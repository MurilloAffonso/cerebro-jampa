  ...
  return (
    <a
      ...
      style={{
        ...
        borderTop: '1px solid rgba(9,34,56,0.08)',
        padding: '10px 14px',
        paddingBottom: 'max(10px, env(safe-area-inset-bottom))',
        boxShadow: '0 -8px 24px -12px rgba(9,34,56,0.20)',
        textDecoration: 'none',
        opacity: isVisible ? 1 : 0,
        pointerEvents: isVisible ? 'auto' : 'none',
        transform: isVisible ? 'translateY(0)' : 'translateY(8px)',
        transition: 'opacity 220ms var(--ease-standard, cubic-bezier(0.4,0,0.2,1)), transform 220ms var(--ease-standard, cubic-bezier(0.4,0,0.2,1))',
      }}
    >
      {price && (
