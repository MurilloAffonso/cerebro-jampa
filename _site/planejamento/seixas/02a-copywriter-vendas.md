...
fontes_consultadas:
  ...
  - _conhecimento/copy-pagina-de-passeio.md
  - _site/planejamento/seixas/01-estrategia-site.md
persona_primaria: turista chegando em JP, primeira vez, intent de decisão
---

# Copy — Piscinas Naturais do Seixas

**Entrega da Etapa 2a — `copywriter-vendas`**
**URL:** `/passeios/piscinas-naturais/seixas`
**Próxima etapa:** 3 `diretor-visual-turismo` (valida padrão visual desta copy)

---

> **Nota de uso:** Esta é copy de rascunho aprovável — pronta para revisão de Murillo. Lacunas marcadas com `[CONFIRMAR]`. Copy aprovada é sagrada: o `programador-de-site` implementa exatamente como Murillo aprovar, sem alterações.
...
> *68 caracteres. Específico: passeio + cidade + atividade + diferencial sensorial.*
...
### Copy do Hero (sobreposta à foto)

*[Texto sobreposto à imagem, sobre overlay escuro — versão curta para mobile]*

"Onde o sol nasce primeiro — você mergulha aqui."

### CTA Primário

**[Reservar no WhatsApp 🟢]**

*Texto antes do botão (mobile, abaixo do subtítulo):*
> "Fala com a gente que a gente te ajuda a escolher a melhor data."

---

## BLOCO 2 — INFO CARD

*Três informações em destaque, acima da dobra — elimina a pergunta "quanto custa?" antes que o turista a faça.*

| 💰 Preço | ⏱ Duração | 📍 Embarque |
|----------|-----------|-------------|
| R$ 60 por pessoa | ~3h30 | Praia de Tambaú |

*Nota de implementação: cada célula tem ícone grande + valor em negrito + label small abaixo. Fundo claro, contraste com o hero escuro acima.*
...
⭐ **4.9/5 no Google**
[CONFIRMAR: número exato de avaliações — ex: "com 147 avaliações"]

*O que os clientes sempre dizem: atendimento rápido, organização impecável, confiança.*
...
## BLOCO 6 — O QUE VOCÊ VAI FAZER

*Tom: sensorial, 1ª pessoa "você", específico de Seixas — não genérico.*

### Título

**O que espera por você em Seixas**
...
## BLOCO 7 — ROTEIRO NARRATIVO

*Formato narrativo (não hora-a-hora), porque é passeio de ~3h30. Cada parada tem o quê + por quê.*

### Título

**Como é o passeio — passo a passo**
...
⚡ **Catamarã é sua base**
Enquanto estiver nas piscinas, o catamarã está ancorado. Toboágua, trampolim e caiaque disponíveis. Bar a bordo para água, bebida e petiscos [CONFIRMAR: o bar vende alimentos? ou só bebidas?]. Banheiro a bordo.
...
## BLOCO 8 — O QUE ESTÁ INCLUSO / NÃO INCLUSO
...
- Snorkel e máscara *(opcional — pergunte o valor no WhatsApp)*
- Máscara de mergulho *(opcional)*
- Fotógrafo subaquático *(opcional — pergunte o valor no WhatsApp)*
- Mergulho com cilindro *(opcional — pergunte o valor no WhatsApp)*
- Transfer até Tambaú *(consultar disponibilidade e valor)*

*Nota de implementação: os "opcionais" devem ter link ou linha "consulte no WhatsApp" — não inventar preços.*

---

## BLOCO 9 — FAQ

*7 perguntas baseadas em fricções reais do público-alvo. Tom: direto, acolhedor, sem enrolação.*

### Perguntas e Respostas

**1. Nunca mergulhei na vida. Posso fazer este passeio?**
...
**2. O passeio realmente depende de maré baixa? E se a maré não estiver boa?**
...
**3. O que exatamente está incluso nos R$ 60?**
...
## BLOCO 9.5 — CTA SECUNDÁRIO (após FAQ)

*Posição: imediatamente após o FAQ accordion. O turista que chegou até aqui já teve objeções respondidas — é o momento de agir antes de continuar scrollando.*

*Tom: leve, sem pressão — convite, não insistência.*

### Frase antes do botão
...
*1 depoimento real em destaque — humaniza e valida.*

[INSERIR DEPOIMENTO REAL]

*Formato desejado:*
> "Frase do cliente sobre a experiência em Seixas — o que sentiu, o que viu, o que achou do atendimento." *(Nome completo, cidade de origem — Google, [mês/ano])*

---

## BLOCO 11 — INFORMAÇÕES PRÁTICAS
...
- Protetor solar — de preferência biodegradável (bom para os corais e pra você)
- Toalha
- Água ou compre a bordo
- [CONFIRMAR: a gente recomenda protetor solar mineral especificamente? ou é livre?]
...
**Vamos te ajudar a escolher a melhor data para o seu passeio em Seixas.**
Atendimento rápido. Preço justo. Roteiro organizado.
...
## BLOCO 13 — PASSEIOS SIMILARES (Links Internos)

### Título

**Outras piscinas naturais em João Pessoa**

### Cards

**Piscinas Naturais da Penha**
Experiência exclusiva — apenas 2 catamarãs por vez. Mais tranquilidade e contato com a natureza.
*R$ 60 por pessoa | ~3h*
[Ver passeio →](/passeios/piscinas-naturais/penha)

**Piscinas Naturais de Picãozinho**
A 1.500 metros de Tambaú. Aquário natural a céu aberto com peixes de todas as cores.
*R$ 60 por pessoa*
[Ver passeio →](/passeios/piscinas-naturais/picaozinho)

---

## CHECKLIST DE QUALIDADE — ETAPA 2a

| Item | Status |
|------|--------|
| Headline específico (não genérico)? | ✅ |
| Lead reconhece problema real do turista? | ✅ |
| Framework AIDA presente? | ✅ |
| Prova de confiança visível (Cadastur, rating, Murillo)? | ✅ (dados de rating e anos precisam de [CONFIRMAR]) |
| CTA é WhatsApp? | ✅ |
| CTA Secundário após FAQ? | ✅ (Bloco 9.5 adicionado) |
| Preço visível (R$ 60)? | ✅ |
| Tom acolhedor, local, sem urgência falsa? | ✅ |
| Dados de passeio confirmados em catálogo? | ✅ (linhas 341–364) |
| Depoimento real ou marcado? | ✅ [INSERIR DEPOIMENTO REAL] |
| Nenhum clichê turístico? | ✅ |
| Aviso de maré — tom educativo, não alarmista? | ✅ |
| Opcionais marcados como opcionais (sem inventar preço)? | ✅ |
...
9. FAQ (accordion)
9.5. CTA Secundário (botão WhatsApp, tom leve)
10. Depoimento (quote block)
11. Informações Práticas (o que levar + ponto)
...
- Aviso de Maré precisa de destaque visual claro (cor âmbar/amarelo? fundo diferenciado?)
- Incluso/Não Incluso: dois blocos lado-a-lado (desktop) ou stack (mobile)
- Depoimento: quote block com aspas grandes ou barra colorida lateral
- CTA Final: seção com fundo escuro ou primário, contraste alto

### Para `seo-local-turismo` (Etapa 4)

- H1 aprovado: "Piscinas Naturais do Seixas, João Pessoa — Snorkel em Água Cristalina"
- Lead contém "João Pessoa" + "Seixas" + "piscinas naturais" + "corais" — pronto para keyword natural
- FAQ tem 7 perguntas naturais sobre maré, mergulho, preço, criança, cancelamento — base para FAQPage schema
- Copy menciona "ponto mais oriental das Américas" — diferencial local único para long-tail
